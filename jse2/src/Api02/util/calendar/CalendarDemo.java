...
public class CalendarDemo {
	public static void main(String[] args) {
		...
		/*
		 * 위 결과를 그대로 출력하면 오늘날짜:2015년5월29일 라고 나온다.
